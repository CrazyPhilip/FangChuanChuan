<template>
	<view>
		<view class="content">
			<u-navbar is-back="true" title="新增房源"></u-navbar>
			<!--必填信息-->
			<u-form :model="model" :rules="rules" ref="uForm0" :errorType="['message']">
				...
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="account" label-width="300"
				 :label-position="labelPosition" label="楼层" prop="floor">
					...
					<view>/</view>
					<u-input :border="border" placeholder="请输入总楼层" v-model="model.floorAll" type="number" inputAlign="center"
				...
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="account" label-width="300" label="房源标题"
				 prop="houseTitle" label-position="top">
				...
				<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="account" label-width="300" label="户型"
				 prop="countF" label-position="top">
			...
			<u-collapse class="moreInfoBox" style="border: 1rpx solid rgb(230, 230, 230); border-radius: 8rpx; padding: 0 10rpx;">
				<u-collapse-item title="添加更多信息">
					...
					<u-form :model="optionalModel" :rules="rules" ref="uForm1" :errorType="['message']">
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="特点" label-width="300" prop="likeFruit">
							<u-checkbox-group @change="checkboxGroupChange" :wrap="true">
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="证件" prop="credentials" label-width="300">
							<u-input :border="border" type="select" :select-open="credentialsListShow" v-model="optionalModel.credentials"
							 placeholder="请选择证件" @click="credentialsListShow = true"></u-input>
						</u-form-item>
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="看房方式" prop="lookWay" label-width="300">
							<u-input :border="border" type="select" :select-open="lookWayListShow" v-model="optionalModel.lookWay"
							 placeholder="请选择看房方式" @click="lookWayListShow = true"></u-input>
						</u-form-item>
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="付佣" prop="commissionPay" label-width="300">
							<u-input :border="border" type="select" :select-open="commissionPayListShow" v-model="optionalModel.commissionPay"
							 placeholder="请选择付佣" @click="commissionPayListShow = true"></u-input>
						</u-form-item>
						<u-picker mode="selector" v-model="commissionPayListShow" :default-selector="[0]" :range="commissionPayList"
						 @confirm="commissionPayListCallback"></u-picker>

						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="付款方式" prop="payment" label-width="300">
							<u-input :border="border" type="select" :select-open="paymentListShow" v-model="optionalModel.payment"
							 placeholder="请选择付款方式" @click="paymentListShow = true"></u-input>
						</u-form-item>
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="权属" prop="ownership" label-width="300">
							<u-input :border="border" type="select" :select-open="ownershipListShow" v-model="optionalModel.ownership"
							 placeholder="请选择权属" @click="ownershipListShow = true"></u-input>
						</u-form-item>
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" :label-position="labelPosition"
						 label="建房年代" prop="builtYear" label-width="300">
							<u-input :border="border" type="select" :select-open="builtYearListShow" v-model="optionalModel.builtYear"
							 placeholder="请选择建房年代" @click="builtYearListShow = true"></u-input>
						</u-form-item>
						...
						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" label="房源备注" prop="Remark"
						 label-position="top">
							<u-input type="textarea" :border="border" placeholder="请填写房源备注(300字)" v-model="optionalModel.Remark" />
						</u-form-item>

						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" label="房源介绍" prop="PropertyIntroduce"
						 label-position="top">
							<u-input type="textarea" :border="border" placeholder="请填写房源介绍(300字)" v-model="optionalModel.PropertyIntroduce" />
						</u-form-item>

						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" label="业主介绍" prop="OwnerIntroduce"
						 label-position="top">
							<u-input type="textarea" :border="border" placeholder="请填写业主介绍(300字)" v-model="optionalModel.OwnerIntroduce" />
						</u-form-item>

						<u-form-item :leftIconStyle="{color: '#888', fontSize: '32rpx'}" left-icon="map-fill" label="服务介绍" prop="ServiceIntroduce"
						 label-position="top">
			...
			ToExtranet() {
				...
				uni.request({
					url: config.outerServer +
						'/property/addProperty?AK=qwert09876nvnvn%40%23r&cityPinYin=chengdu&cityName=default',
					method: 'POST',
					data: {
