<template>
	<view>
		...
		<!-- <u-navbar back-icon-name="arrow-leftward" :is-back="true" :title="house.Title" background="transparent">
			<view slot="right">
				<u-icon class="rightIcon" :name="collectIcon" size="48" @click="goBack()"></u-icon>
				<u-icon class="rightIcon" :name="shareIcon" size="48" @click="goBack()"></u-icon>
			</view>
		</u-navbar> -->
		...
		<view class="navigation">
			<view class="left">
				<u-row>
					<u-col span="3"><u-button type="success" @click="Call">致电</u-button></u-col>
					...
					<u-col span="3"><u-button type="warning" @click="Call">修改房源</u-button></u-col>
				</u-row>
